...
public class LightningAdapter extends ArrayAdapter<Lightning> {

    public LightningAdapter(Context context, ArrayList list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Lightning currentCategoryItem = getItem(position);
